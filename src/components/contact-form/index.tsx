    ...
    <div className={props.className}>
      ...
      <div className='relative mt-1'>
        <Field
          {...field}
          {...props}
          className='block w-full shadow-sm caret-primary-500 focus:ring-primary-500 focus:border-primary-500 rounded-md'
        />
...
const TextareaInput = (
  ...
  return (
    <textarea
      className={`py-3 px-4 block w-full shadow-sm focus:ring-primary-500 focus:border-primary-500 rounded-md ${props.className}`}
      {...props}
    />
  );
};
                        ...
                        {state ? (
                          ...
                          <div>
                            ...
                            <div className='grid grid-cols-1 sm:grid-cols-2'>
                              <div className='mt-4'>
                                <PhoneIcon
                                  className='mx-auto text-primary-500 w-6 h-6'
                                  aria-label='Phone'
                                />
